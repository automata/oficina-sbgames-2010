/*
  ...
  Sketch: WiichuckPongGame
  Language: Processing
  Last Modified: February 27, 2010
  
  Dependencies: WiichuckPongReader.pde (Arduino/Wiring)
  
  Uses the values from a Nintendo Wii Nunchuk to animate a game of pong.
  ...
  This code is entirely based on the Monski Pong example from
  Tom Igoe's book "Making Things Talk."
    http://www.makingthingstalk.com/chapter2/54/
...
// these depend on the range of  acceptable values from your Nunchuk
float leftMinimum = 70;         // minimum value of the left sensor
float rightMinimum = 65;        // minimum value of the right sensor
float leftMaximum = 185;         // maximum value of the left sensor
float rightMaximum = 165;        // maximum value of the right sensor
