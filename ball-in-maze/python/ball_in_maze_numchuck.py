...
class World(DirectObject):
  ...
  def rollTask(self, task):
    ...
    if linha != '':
      ...
      leftRange = leftMaximum - leftMinimum
      rightRange = rightMaximum - rightMinimum

      left = 20*(ax - leftMinimum)/leftRange
      right = 20*(ay - rightMinimum)/rightRange
      rato.y = translate(ay, 50, 190, -1, 1)
      rato.x = translate(ax, 50, 190, -1, 1)
