...
class World(DirectObject):
  ...
  def rollTask(self, task):
    ...
    if linha != '':
      ax = float(arduino.readline()) # 70 - 182
      ay = float(arduino.readline()) # 65 - 173
      nx = float(arduino.readline()) # 70 - 182
      ny = float(arduino.readline()) # 65 - 173      
      direcaox = 0
      direcaoy = 0
      ...
      print 'x', rato.x, 'y', rato.y
      self.maze.setR(rato.x * 1)
      self.maze.setP(rato.y * -1)
      #self.maze.setP(novoy * -1)
      #self.maze.setR(novox * 1)
